...
class EICAS_Logic extends BaseInstrument {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        {
            const code = document.getElementById('EICAS_BUNDLED_STYLE').innerHTML;
            const style = document.createElement('style');
            style.innerHTML = code;
            document.head.appendChild(style);
        }
        {
            const code = document.getElementById('EICAS_BUNDLED_LOGIC').innerHTML;
...
registerInstrument('eicas-element', EICAS_Logic);
