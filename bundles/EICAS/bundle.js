(function () {
	...
	*/
	...
	const EICAS = () => {
	  const [apuPCT] = useSimVar('APU PCT RPM', 'percent');
	  const [temp] = useSimVar('STANDARD ATM TEMPERATURE', 'fahrenheit');
	  var [pressPSI1] = useSimVar('RECIP ENG MANIFOLD PRESSURE', 'psi');
	  var [pressPSI2] = useSimVar('RECIP ENG MANIFOLD PRESSURE', 'psi');
	  var [pressPSI3] = useSimVar('RECIP ENG MANIFOLD PRESSURE', 'psi');
	  var [pressPSI4] = useSimVar('RECIP ENG MANIFOLD PRESSURE', 'psi');
	  var [HYD1] = useSimVar('ENG OIL TEMPERATURE', 'fahrenheit');
	  var [HYD1] = useSimVar('ENG OIL QUANTITY', 'gallons');
	  var [HYD2] = useSimVar('ENG OIL TEMPERATURE', 'fahrenheit');
	  var [HYD2] = useSimVar('ENG OIL QUANTITY', 'gallons');
	  var [HYD3] = useSimVar('ENG OIL TEMPERATURE', 'fahrenheit');
	  var [HYD3] = useSimVar('ENG OIL QUANTITY', 'gallons');
	  var [HYD4] = useSimVar('ENG OIL TEMPERATURE', 'fahrenheit');
	  var [HYD4] = useSimVar('ENG OIL QUANTITY', 'gallons');
	  var [fuel1] = useSimVar('FUELSYSTEM TANK WEIGHT', 'gallons');
	  var [fuel2] = useSimVar('FUELSYSTEM TANK WEIGHT', 'gallons');
	  var [fuel3] = useSimVar('FUELSYSTEM TANK WEIGHT', 'gallons');
	  var [fuel4] = useSimVar('FUELSYSTEM TANK WEIGHT', 'gallons');
	  pressPSI1 = Math.floor(pressPSI1 / 50) * 50;
	  pressPSI2 = Math.floor(pressPSI2 / 50) * 50;
	  pressPSI3 = Math.floor(pressPSI3 / 50) * 50;
	  pressPSI4 = Math.floor(pressPSI4 / 50) * 50;
	  var apuTemp = Math.round(apuPCT * 3.5) + temp;
	  return /*#__PURE__*/jsxRuntime.jsxs("svg", {
	    ...
	    children: [/*#__PURE__*/jsxRuntime.jsx("rect", {
	      ...
	      x: 0,
	      y: 0,
	      xlinkHref: "/Images/ENV ON.003.png",
	      width: 1280,
	      height: 1280,
	      opacity: 0.4
	    }), /*#__PURE__*/jsxRuntime.jsx("image", {
	      x: 0,
	      y: 0,
	      xlinkHref: "/Images/C17 v7 MssssAIN_$OHDISP_BaseColor.png",
	      width: 1280,
	      height: 1280,
	      opacity: 0.4
	...
	render( /*#__PURE__*/jsxRuntime.jsx(EICAS, {}));
