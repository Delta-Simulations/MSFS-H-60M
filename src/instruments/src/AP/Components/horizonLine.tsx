    ...
    return(
        <g>
            <g transform={`translate(0 ${props.height}) `}>
                ...
                <text x={502} y={8} fontSize={23} fill="white" className='ESIS' textAnchor="middle">{props.label}</text>
                <text x={656} y={8} fontSize={23} fill="white" className='ESIS' textAnchor="middle">{props.label}</text>
            </g>
        </g>
    )
};
