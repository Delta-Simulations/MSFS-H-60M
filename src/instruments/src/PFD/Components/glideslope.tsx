        ...
        <g>
            <g transform={`translate(127, 66), scale(0.7)`}>
                <g transform={`translate(0, ${-glide2*15.5})`}>
                    <g transform={`translate(1165.5, 521), rotate(45)`}>
                        <rect x={0} y={0} width={35} height={35} stroke='#2CE832' strokeWidth={5} fill='black'/>
                    </g>
                </g>
                <g>
                    ...
                    <rect x={1148} y={535} width={35} height={22} stroke='#2CE832' strokeWidth={5} fill='none'/>
                </g>
            </g>
            ...
            <g transform={`translate(127, 310), scale(0.7)`}>
                <g transform={`translate(-401, -185) rotate(90, 800, 800)`}>
                    ...
                    <rect x={1148} y={533} width={35} height={22} stroke='#2CE832' strokeWidth={5} fill='black'/>
                </g>
