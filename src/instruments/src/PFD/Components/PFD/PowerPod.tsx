...
export const PowerPod = () => {
    ...
    let [Tot_Fuel] = useSimVar('A:FUEL TOTAL QUANTITY WEIGHT', 'pounds');
        ...
        let [Q2] = useSimVar('A:ENG TORQUE PERCENT:2','percent');
        let [NP_1] = useSimVar('A:ENG RPM ANIMATION PERCENT:1','percent');
        let [NP_2] = useSimVar('A:ENG RPM ANIMATION PERCENT:2','percent');
        ...
        let NR: number = 1;
        let [RTR_RPM] = useSimVar('A:ROTOR RPM PCT:1','percent');
