			...
			<g>
				...
				<g transform="translate(0,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(TMP_1 * 1.65 - 115, 160), 0)}
						className={
							TMP_1 < 135
								? "tapeGreen"
								: TMP_1 <= 150
				...
				<g transform="translate(70.5,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(PRESS_1 * 1.2 - 10, 160), 0)}
						className={
							PRESS_1 <= 22
								? "tapeRedStripes"
								: PRESS_1 <= 26
				...
				<g transform="translate(144.3,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(NG_1 * 30 - 3075, 160), 0)}
						className={
							NG_1 <= 105
								? "tapeGreen"
								: NG_1 <= 106
				...
				<g transform="translate(221.5,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(TGT_1 * 0.33 - 154, 160), 0)}
						className={
							TGT_1 < 793
								? "tapeGreen"
								: TGT_1 <= 879
				...
				<g transform="translate(301.4,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(Q1 * 1.39 - 55, 160), 0)}
						className={
							Q1 <= 120
								? "tapeGreen"
								: Q1 <= 144
				...
				<g transform="translate(384.5,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(NP_1 * 6 - 500, 160), 0)}
						className={
							NP_1 <= 91
								? "tapeRedStripes"
								: NP_1 < 95
				...
				<g transform="translate(462.5,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(NR * 6 - 510, 160), 0)}
						className={
							NR <= 90
								? "tapeRedStripes"
								: NR < 95
				...
				<g transform="translate(541,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(NP_2 * 6 - 500, 160), 0)}
						className={
							NP_2 <= 91
								? "tapeRedStripes"
								: NP_2 < 95
				...
				<g transform="translate(624,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(Q2 * 1.39 - 55, 160), 0)}
						className={
							Q2 <= 120
								? "tapeGreen"
								: Q2 <= 144
				...
				<g transform="translate(703.5,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(TGT_2 * 0.33 - 154, 160), 0)}
						className={
							TGT_2 < 793
								? "tapeGreen"
								: TGT_2 <= 879
				...
				<g transform="translate(780.7,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(NG_2 * 30 - 3075, 160), 0)}
						className={
							NG_2 <= 105
								? "tapeGreen"
								: NG_2 <= 106
				...
				<g transform="translate(855.1,0)">
					<rect
						...
						y={159}
						width="26"
						height={Math.max(Math.min(PRESS_2 * 1.2 - 10, 160), 0)}
						className={
							PRESS_2 <= 22
								? "tapeRedStripes"
								: PRESS_2 <= 26
